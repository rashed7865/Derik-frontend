          ...
          <div class="container">
            ...
            <div className="col-md-6 col-7">
              ...
              <h1 style={{ color: 'red', fontSize: '1.5rem', marginBottom: '1px' }}>
                  ...
                  قم بتسجيل الدخول لتجربة تسوق شخصية، وللوصول إلى أحدث المنتجات والعروض الحصرية </p>
        ...
        <div class="carousel-item ">
          <div class="container">
            ...
            <div className="col-md-5 col-6">
                <div class="detail-box">
                  <h1>                  <p style={{ fontSize: '1.5rem' }}>  

                  تسوّق بأمان وراحة في مكان واحد<br/> </p>
                  
                  </h1>
                  <p>
                  يمكنك تصفح واختيار المنتجات التي ترغب فيها دون الحاجة إلى تسجيل الدخول. ولكن لإتمام عملية الشراء والاستفادة من خيارات الدفع والتوصيل، يرجى تسجيل الدخول إلى حسابك أو إنشاء حساب           </p>
                  <a href="tel:+963999229437">
                اتصل بنا
              </a>
                </div>
